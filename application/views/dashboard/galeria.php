          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h4 class="card-title">Año 2022</h4>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-2">
                    <a href="<?php echo base_url(); ?>assets/img/galeria/galera/foto1.jpeg" data-toggle="lightbox" data-title="Equipo 2022" data-gallery="gallery">
                      <img src="<?php echo base_url(); ?>assets/img/galeria/galera/foto1.jpeg" class="img-fluid mb-2" alt="white sample"/>
                    </a>
                  </div>
                  <div class="col-sm-2">
